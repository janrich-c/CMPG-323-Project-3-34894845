...
namespace DeviceManagement_WebApp.Controllers
{
    public class DevicesController : Controller
    {
        ...
        public async Task<IActionResult> Details(Guid? id)
        {
            ...
            var device = await _deviceRepository.GetDetails(id);
            if (device == null)
            {
                return NotFound();
            }
        ...
        {
            ViewData["CategoryId"] = new SelectList(_deviceRepository.GetCatg(), "CategoryId", "CategoryName");
        ...
        {
            var NewDevice = await _deviceRepository.Create(device);
        ...
        public async Task<IActionResult> Edit(Guid? id)
        {
            ...
            ViewData["CategoryId"] = new SelectList(_deviceRepository.GetCatg(), "CategoryId", "CategoryName", device.CategoryId);
